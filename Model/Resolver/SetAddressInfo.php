...
/**
 * Resolver for shopwareSetAddressInfo mutation
 */
class SetAddressInfo implements ResolverInterface
{
    /**
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        try {
            ...
            return $this->formatCartData($response);
        } catch (\Exception $e) {
            $this->logger->error('SetAddressInfo Resolver Error', ['error' => $e->getMessage()]);
            throw new \GraphQL\Error\UserError('Failed to set address info: ' . $e->getMessage());
        }
    }
